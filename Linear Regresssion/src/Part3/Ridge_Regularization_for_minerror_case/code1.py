...
j=5
l=0.25
print('Ridge regularization for order=4 and l=0.25')
...
for itr in range(0,200):
    ...
    X1[itr][0]=1
print('Test Error:')
F1_min.append(cal_cost(theta,X1,Y1,l))
print(F_min[0])
print('\n')
...
j=5
l=0.5
print('Ridge regularization for order=4 and l=0.5')
theta=np.random.randn(j,1)
X=np.zeros((1000,j))
Y=np.zeros((1000,1))
x,y=np.genfromtxt('C:\\ML\\train.csv',unpack=True,delimiter=',')
...
j=5
l=0.75
print('Ridge regularization for order=4 and l=0.75')
theta=np.random.randn(j,1)
X=np.zeros((1000,j))
Y=np.zeros((1000,1))
x,y=np.genfromtxt('C:\\ML\\train.csv',unpack=True,delimiter=',')
